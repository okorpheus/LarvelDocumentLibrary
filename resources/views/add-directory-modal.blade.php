<div x-show="showAddDirectoryForm">
    <backdrop
    ...
    <div tabindex="0"
        ...
        <el-dialog-panel
            @click.outside="showAddDirectoryForm = false"
        ...
        >
            <form method="POST" action="{{ route('document-library.directory.store') }}">
                @csrf
                ...
                <div>
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        <h3 id="dialog-title" class="text-base font-semibold text-gray-900 dark:text-white">Add
                            Directory</h3>
                        <div class="mt-2 text-left">
                            ...
                            <div class=" relative ">
                                ...
                                <input type="text"
                                       ...
                                       name="name" placeholder="New Directory Name"/>
                            </div>
