<div x-show="showEditDirectoryForm" x-cloak>
    <backdrop
    ...
    <div tabindex="0"
        ...
        <el-dialog-panel
            @click.outside="showEditDirectoryForm = false"
        ...
        >
            <form method="POST" :action="editDirectoryAction" x-ref="editDirectoryForm">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        <h3 id="dialog-title" class="text-base font-semibold text-gray-900 dark:text-white">Edit
                            Directory</h3>
                        <div class="mt-2 text-left">

                            <div class="relative">
                                <label for="edit-name" class="text-gray-700">
                                    Directory Name
                                </label>
                                <input type="text"
                                       x-model="editDirectory.name"
                                       ...
                                       name="name" id="edit-name" placeholder="Directory Name"/>
                            </div>

                            <div class="mt-3">
                                <label class="text-gray-700" for="edit-description">Description (optional)</label>
                                <textarea
                                    x-model="editDirectory.description"
                                    ...
                                    id="edit-description" placeholder="Directory Description (optional)" name="description"
                                    rows="5" cols="40"></textarea>
                            </div>

                            <div class="mt-3">
                                <label class="text-gray-700" for="edit-visibility">
                                    Visibility
                                </label>
                                <select id="edit-visibility"
                                        x-model="editDirectory.visibility"
                ...
                <div class="mt-5 sm:mt-6 flex gap-3">
                    <button type="button"
                            @click="showEditDirectoryForm = false"
